...
const TESTIMONIALS = [
  ...
  {
    quote:
      "Their AI and automation work removed two full-time roles of manual coordination from our logistics stack. The dashboard alone paid for the engagement in six weeks.",
        ...
        <div className="grid lg:grid-cols-3 gap-5">
          {TESTIMONIALS.map((t, index) => (
            <Reveal key={t.name} delay={index * 0.1}>
              <article
                className={`glass-card p-7 flex flex-col h-full ${t.accent === "coral" ? "glass-card-coral" : ""}`}
              >
